                ...
                {patientData ? (
                    <div className="card">
                        <section className="section">
                            ...
                            <p className="info-item"><span className="info-label">Ім'я:</span> {patientData.first_name}
                            </p>
                            ...
                            <p className="info-item"><span className="info-label">Стать:</span> {patientData.gender}</p>
                        </section>
                        <section className="section">
                            <h1 className="section-title">Контакти</h1>
                            <p className="info-item"><span className="info-label">Email:</span> {patientData.email}</p>
                            <p className="info-item"><span
                                className="info-label">Телефон:</span> {patientData.phone_number}</p>
                            <p className="info-item"><span className="info-label">Адреса:</span> {patientData.address}
                            </p>
                        </section>
                    </div>
                ) : (
